			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form role="form" id="addForm">
				  ...
				  <button id="resBtn" type="button" class="btn btn-danger"><i class="glyphicon glyphicon-refresh"></i> 重置</button>
				</form>
			  </div>
			</div>
        </div>
	...
	<script type="text/javascript" src="${APP_PATH }/jquery/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            $("#addBtn").click(function(){
            	...
            	if(floginacct.val()==""||fusername.val()==""||femail.val()==""){
            		layer.msg("请输入完整信息！",{time:1000,icon:5,shift:6});
            		return false;
            	}
            	...
            	$.ajax({
            		...
            		success:function(result){
            			if(result.success){
            				...
            				layer.msg("新增失败，请重新操作！",{time:1000,icon:5,shift:6});
            			}
            		},
            		error:function(){
            			layer.msg("新增失败，请重新操作！",{time:1000,icon:5,shift:6});
